...
create policy "anon can insert workouts" on public.workouts for insert to anon with check (true);
create policy "anon can read workouts" on public.workouts for select to anon using (true);
create policy "anon can delete workouts" on public.workouts for delete to anon using (true);
create policy "anon can insert workout exercises" on public.workout_exercises for insert to anon with check (true);
create policy "anon can read workout exercises" on public.workout_exercises for select to anon using (true);
create policy "anon can update workout exercises" on public.workout_exercises for update to anon using (true) with check (true);
create policy "anon can delete workout exercises" on public.workout_exercises for delete to anon using (true);
create policy "anon can read exercise catalog" on public.exercise_catalog for select to anon using (true);
create policy "anon can insert body weights" on public.body_weights for insert to anon with check (true);
create policy "anon can read body weights" on public.body_weights for select to anon using (true);
create policy "anon can update body weights" on public.body_weights for update to anon using (true) with check (true);
create policy "anon can delete body weights" on public.body_weights for delete to anon using (true);
